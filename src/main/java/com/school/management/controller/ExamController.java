...
public class ExamController {
	...
	public ArrayList<ExamMarks> getTermClassStudentsMarks(@RequestParam Integer classId,@RequestParam Integer examId,@RequestParam Integer sectionId,@RequestParam Integer subjectId) {
